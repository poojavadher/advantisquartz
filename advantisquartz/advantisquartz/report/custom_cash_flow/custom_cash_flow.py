...
def execute(filters=None):
	...
	for cash_flow_account in cash_flow_accounts:
		...
		# 			{"indent": 1, "parent_account": cash_flow_accounts[1]["section_header"]}
		# 		)
...
def get_cash_flow_accounts():
	opening_balance = {
		"section_name": "balances",
		"section_footer": _("Total Balance"),
		"section_header": _("Opening Balance"),
		"account_types": [
			{"account_type": "Bank", "label": _("Bank Accounts")},
			{"account_type": "Cash", "label": _("Cash-in-Hand")},
		],
	}
	...
	return [opening_balance, operation_accounts, investing_accounts, financing_accounts]
