	...
	for key, wo_data in wo_items.items():
		for index, row in enumerate(wo_data):
			if index != 0:
				...
				for field in ["name", "status","bom_no", "production_item", "qty", "produced_qty"]:
					row[field] = ""
...
def get_columns():
	return [
		...
		{"label": _("Bom"), "fieldname": "bom_no", "fieldtype": "Data", "width": 150}, 
		{"label": _("Quantity/Slab Formula"), "fieldname": "quantity_per_slab_formula", "fieldtype": "Data", "width": 150}, 
